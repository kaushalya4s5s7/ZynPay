...
const defaultSteps: readonly Step[] = [
  {
    ...
    name: "Step 1",
    title: "Add Employees",
    description: "Import your team from CSV or add manually. Include role, salary, and location details.",
  },
  {
    id: "2",
    name: "Step 2",
    title: "Define Payment Rules",
    description: "Set up payment schedules, currencies, and local compliance rules automatically.",
  },
  {
    id: "3",
    name: "Step 3",
    title: "Auto-generate Payslips",
    description: "Tax calculations, deductions, and payslips generated instantly for all countries.",
  },
  {
    id: "4",
    name: "Step 4",
    title: "1-click Global Payout",
    description: "Send payments to 120+ countries with one click. No manual transfers needed.",
  },
] as const
