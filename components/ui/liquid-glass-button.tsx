  ...
  return (
    <>
      <Comp
        ...
        {...props}
      >
        <div className="absolute top-0 left-0 z-0 h-full w-full rounded-full text-white/100
        ...
        <div
          className="absolute top-0 left-0 isolate -z-10 h-full w-full overflow-hidden rounded-md text-white/100"
